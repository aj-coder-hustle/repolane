...
2. On yes: run `$AD/bin/lane-start <id> <repo> ...` and show its output.
...
4. Draft the Goal section of registry/lanes/<id>.md from the request, show it, write it on his ok. Then wait.
